@can ('accept',$model)
    <a title="Mark this answers as best answer" class="{{$model->status}} mt-2" 
    onclick="event.preventDefault(); Style='display:none'; document.getElementById('accept-answer-{{$model->id}}').submit();">
